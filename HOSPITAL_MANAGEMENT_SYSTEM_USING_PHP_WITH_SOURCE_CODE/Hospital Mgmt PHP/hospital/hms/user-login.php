			...
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="box_login">
					<form class="form-login" method="post">
							...
							<div class="new-account text-white bg-dark">
					...
					<div class="copyright text-white bg-dark">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> MASAA</span>. <span>All rights reserved</span>
					</div>
